...
\title{Lista de Exercícios: Grafos \footnote{Material baseado em Cormen, Leiserson, Rivest e Stein (CLRS), \emph{Introduction to Algorithms}, 4ª ed., MIT Press, 2022, capítulos 12 e 13.}}
...
\begin{enumerate}
  \item Implemente o algoritmo de PRIM utilizazando \textbf{listas de adjacência}. 
  \item Implemente o algoritmo de Dikjstra utilizando \textbf{matriz de adjacência}.
  \item Considere um grafo implementado como uma matriz de adjacência.
  \begin{enumerate}
    \item Implemente a operação \texttt{remover\_vertice(key)}
    \item Implemente a operação \texttt{inserir\_vertice(key)}
    \item Implemente a operação \texttt{remover\_aresta(u,v)}
    \item Implemente a operação \texttt{inserir\_aresta(u,v)}
  \end{enumerate}
  \item Considere um grafo implementado como uma lista de adjacência.
\end{enumerate}
