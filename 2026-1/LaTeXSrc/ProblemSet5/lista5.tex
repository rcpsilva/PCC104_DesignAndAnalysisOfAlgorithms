...
\title{Lista de Exercícios: Grafos e Algoritmos de Busca\footnote{Material baseado em Cormen, Leiserson, Rivest e Stein (CLRS), \emph{Introduction to Algorithms}, 4ª ed., MIT Press, 2022, capítulos 12 e 13.}}
...
\begin{enumerate}
  \item Reimplemente o algoritmo de busca visto em sala utilizando a representação de grafos em matriz de adjacência. 
  \item Calcule o custo em memória e número de operações das versões em largura e em profundidade.
\end{enumerate}
